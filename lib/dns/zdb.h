...
/*! \file
 * \brief
 * DNS DB Implementation for Authoritative Zones
 */

ISC_LANG_BEGINDECLS

isc_result_t
dns_zdb_create(isc_mem_t *mctx, const dns_name_t *base, dns_dbtype_t type,
	       dns_rdataclass_t rdclass, unsigned int argc, char *argv[],
	       void *driverarg, dns_db_t **dbp);

/*%<
 * Create a new database of type "zdb" (or "zdb64").  Called via
